        ...
        <td style="vertical-align:middle">
          <table cellpadding="0" cellspacing="0"><tr>
            <td style="padding-right:12px;vertical-align:middle">
              <img src="https://smartcoretechnology.co.uk/SmartCore%20Official%20Logos/SC%20Icon%20-%20Black%20Background.png" alt="SmartCore" width="40" height="40" style="display:block;border-radius:10px" />
            </td>
            <td style="vertical-align:middle">
  ...
  <tr>
    <td style="padding:0 36px 28px">
      <table width="100%" cellpadding="0" cellspacing="0" style="margin-top:12px">
        ...
        <tr>
          <td colspan="2" style="font-size:12px;color:#9ca3af;padding-bottom:8px">${o.billing_type === 'yearly' ? 'Annual' : 'Monthly'} subscription · ${o.size_tier ? o.size_tier.charAt(0).toUpperCase() + o.size_tier.slice(1) : ''} tier (×${multiplier})</td>
        </tr>
      </table>
    </td>
  </tr>
