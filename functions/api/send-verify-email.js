...
.logo-mark{width:42px;height:42px;background:linear-gradient(135deg,#5b8fff 0%,#3060d0 100%);border-radius:12px;display:flex;align-items:center;justify-content:center;font-size:21px;font-weight:900;color:#fff}
