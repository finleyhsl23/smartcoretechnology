...
function renderSettings() {
  ...
  if ($("minimumOrderLabel")) $("minimumOrderLabel").textContent = `Minimum order ${money(settings.minimum_order)}`;
  if ($("deliveryDaysLabel")) $("deliveryDaysLabel").textContent = settings.delivery_days;
  if ($("deliveryTimesLabel")) $("deliveryTimesLabel").textContent = settings.delivery_times;

  if ($("deliverySettingMinimum")) $("deliverySettingMinimum").textContent = `Minimum order: ${money(settings.minimum_order)}`;
  if ($("deliverySettingDays")) $("deliverySettingDays").textContent = `Delivery days: ${settings.delivery_days}`;
  if ($("deliverySettingTimes")) $("deliverySettingTimes").textContent = `Delivery times: ${settings.delivery_times}`;
}
