...
async function init() {
  ...
  document.getElementById('exportAllEmployeesBtn')?.addEventListener('click', exportAllEmployeesToCsv);
...
async function exportAllEmployeesToCsv() {
  const btn = document.getElementById('exportAllEmployeesBtn');
