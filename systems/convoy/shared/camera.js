// Live camera photo capture for Convoy. Deliberately does not use
// <input type="file" capture>, which on many browsers just opens the OS
// camera app / gallery and hands back a file — this drives an in-page
// <video> preview so a zone photo is provably taken at that moment, not a
// pre-existing photo from the gallery. Defaults to the rear ("environment")
// camera since this is vehicle documentation, not a selfie flow.
